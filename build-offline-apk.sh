...
# Script para compilar APK em modo offline (contornando problemas de rede)
echo "Iniciando compilação do APK em modo offline..."
...
if [ -f "$APK_PATH" ]; then
  ...
  # Copiar o APK para uma localização mais amigável
  mkdir -p public/apk
